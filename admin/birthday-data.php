...
?>
    ...
    if (isset($_POST["upload"])) {
        ...
        if (!file_exists($_FILES["file-input"]["tmp_name"])) {
            ...
            $target = "../birthday/" . $imagename; //file location
            $link = 'https://' . $_SERVER['HTTP_HOST'] . '/star/birthday/'.$imagename;
...
if(mysqli_num_rows($rs) > 0){
    ...
    echo " <a class='links' href='birthday.php'>UPLOAD ANOTHER</a>";
exit;
}
else if (isset($_POST['upload'])) {
            ...
            if (move_uploaded_file($_FILES["file-input"]["tmp_name"], $target)) {
                ...
                if (isset($_POST['upload'])) {
                    ...
                    $qrcode = 'https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=https%3A%2F%2F' . $_SERVER['HTTP_HOST'] . '/star/birthday/' . $url; //file location

                    echo "<br>Image URL is :\t" . "<a class='url-output' href='https://$_SERVER[HTTP_HOST]/star/birthday/$url'>https://$_SERVER[HTTP_HOST]/star/birthday/$url</a>" . "<br>"; //file location
    ...
    <body class="data-size">
        ...
        <a class="links" href="birthday.php">UPLOAD ANOTHER</a>
        <!-- add proper link -->
    </body>
